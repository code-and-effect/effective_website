...
Devise.setup do |config|
  ...
  # config.secret_key = '66c351893fd765ebd0c37da17e8b5cc50220faee07d15a8b5940eed033b015ace350a78869eaa0156569212638c57851a360fc77673acfcec15ff7d9ff019022'
  ...
  # given strategies like `config.params_authenticatable = [:database]` will
  # enable it only for database (email + password) authentication.
  # config.params_authenticatable = true

  # Tell if authentication through HTTP Auth is enabled. False by default.
  # It can be set to an array that will enable http authentication only for the
  # given strategies like `config.http_authenticatable = [:database]` will
  ...
  # config.pepper = 'f0d44bc5e951e395bd8ea2d898610f0bbf3daca4c089377137914fc4c28ef0f6c7f91e29408427438110fdf5ce45265ccd0a5d4d0d27447772d18fc9ed075b65'
  ...
  # token becomes invalid. If set to 3.days, the user can confirm
  ...
  #
  # The router that invoked `devise_for`, in the above, would be:
